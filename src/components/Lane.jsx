...
const Lane = ({ subreddit }) => {
  ...
  return (
    <div className='relative border-2 border-mcoolgray m-1 w-xs min-w-xs max-w-xs h-[85vh] rounded-md flex flex-col space-y-0'>
      ...
      <LaneHeader subreddit={subreddit} onClickRefresh={refreshSelf} />  
      {/*  onClickDelete={}/>    */}
      ...
      <div className='relative scrollable-content overflow-y-scroll scrollbar-hidden fade h-full'>
        ...
        {loading ? (
          ...
          <div className='h-full w-full flex items-center justify-center'>
            <svg aria-hidden="true" class="w-[25%] h-[25%] text-mcoolmid animate-spin dark:text-gray-600 fill-mcoolgray" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
